...
class PathHierarchyAggregatorFactory extends ValuesSourceAggregatorFactory {
    ...
    private final PathHierarchyAggregatorSupplier aggregatorSupplier;
    ...
    PathHierarchyAggregatorFactory(String name,
                                   ...
                                   PathHierarchyAggregatorSupplier aggregationSupplier
    ) throws IOException {
    ...
    static void registerAggregators(ValuesSourceRegistry.Builder builder) {
        builder.register(PathHierarchyAggregationBuilder.REGISTRY_KEY,
                Collections.singletonList(CoreValuesSourceType.KEYWORD),
                PathHierarchyAggregator::new, true
        );
    }
